...
class SearchProperties extends SearchDelegate<PropertyItem> {
  ...
  Widget buildResults(BuildContext context) {
    ...
    final properties =
        Provider.of<Properties>(context, listen: false).properties;
    final sProperties = (query.isNotEmpty)
        ? properties.where((element) {
            bool status = false;
            ...
            if (element.property_name
                ...
                element.description
                    .toLowerCase()
                    .contains(query.trim().toLowerCase())) status = true;
            return status;
          }).toList()
        : properties;
