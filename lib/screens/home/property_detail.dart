                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          buildFeature(Icons.hotel, property2.bedrooms.toString() + " Bedroom"),
                          buildFeature(Icons.wc, property2.bathrooms.toString() + " Bathroom"),
                          buildFeature(Icons.kitchen,  property2.rooms.toString() + " Room"),
                          buildFeature(Icons.local_parking, property2.construction_status.toString() ),
